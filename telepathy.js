(() => {
  ...
  const runtimeBuildVersion = "20260707c";
  ...
  function notifyGuidedReceiverTourPhase(phase) {
    ...
    if (phase === "receiving") {
      setGuidedReceiverTourStep({
        id: "receiving-intro",
        text: "At the end of the countdown, a short beep marks the start of the receiving interval. Your eyes could be closed and you should inspect what appears in your mindÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s eye at this time. The beep marks the time that an image appears before the senderÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s eyes. When a person views a change in their visual field, a flurry of brain activity occurs as they grasp what new information appears before them. You, the receiver, know exactly when this is happening for the sender, and so, the fast traveling information will be new for you, too. This is the best time to try to observe new visual information in your mindÃƒÂ¢Ã¢â€šÂ¬Ã¢â€žÂ¢s eye.",
        target: countdownBox,
        keepTargetBright: true,
        showNext: true,
        nextLabel: "NEXT",
